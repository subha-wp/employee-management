...
import { Home, Clock, CheckSquare, User, BarChart3, LogOut, X, Shield } from "lucide-react"
    ...
    <>
      ...
      <div className="hidden md:flex fixed left-0 top-0 z-40 h-full bg-white border-r border-slate-200 w-64 flex-col">
                ...
                <li key={item.id}>
                  <Button
                    ...
                    className={cn(
                      ...
                      activeTab === item.id ? "bg-primary/10 text-primary" : "text-slate-700 hover:bg-slate-50",
                    )}
        ...
        <div className="p-4 border-t border-slate-200">
          <Button variant="ghost" className="w-full justify-start gap-3 text-slate-700" onClick={logout}>
